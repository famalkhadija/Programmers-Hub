...
bg-opacity-50 dark:bg-opacity-80"
  ...
  <h1 className=" text-2xl lg:text-4xl font-bold mb-6 text-center">About Us</h1>
  ...
  <ul className="list-disc pl-6 mb-8 space-y-2  md:text-base">
    <li><strong>Real-Time Discussions:</strong> Join active groups for every major programming language — JavaScript, Python, Java, TypeScript, and more.</li>
    <li><strong>Mock Quizzes:</strong> Practice with language-specific quizzes tailored for both beginners and advanced learners. Questions refresh every time for a unique experience.</li>
    <li><strong>Learn Together:</strong> Ask questions, share knowledge, and grow with a community that loves coding as much as you do.</li>
    <li><strong>Private Groups:</strong> Create private discussions with invite-only access for focused learning or team collaboration.</li>
  </ul>
  ...
  <p className="text-base">
    ...
    Create an account, pick your favorite language, and start exploring!
  </p>
</div>
